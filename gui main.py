...
image2 =Image.open(r'C:\Users\HP\Desktop\project final year\visual cryptography_final 1\visual cryptography_final 1\vv.webp')
from PIL import Image

Eimage2 = image2.resize((1587, 900), Image.Resampling.LANCZOS)
